...
def medved(size, x, y):
    ...
    d.ellipse(screen, (0, 0, 102), (x + N * (0.5 + (1 / 2 - 7 / 16) / 2), y + N * (1 - 3 / 16), 7 * N / 16, 3 * N / 16),
              0)  # water
    d.ellipse(screen, (0, 0, 0), (x + N * (0.5 + (1 / 2 - 7 / 16) / 2), y + N * (1 - 3 / 16), 7 * N / 16, 3 * N / 16),
              1)
...
d.circle(surface1,( 25, 235, 25,150), (1125, 150), 150, 0) # the Sun
