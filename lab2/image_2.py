...
surface1 = screen.convert_alpha() #создание поверхности с альфа каналом
surface1.fill([0,0,0,0])#заливка поверхности белым

def medvedR(size, x, y,fish):
    ...
    d.line(screen, (0, 0, 0), (x + N * 3 / 8, y + N / 2), (x + N * 3 / 4, y), int(5*N/500))  # fishing rod
    ...
    d.line(screen, (0, 0, 0), (x + N * 3 / 4, y), (x + N * 3 / 4, y + N * (1 - 1 / 8)), 1)  # spinning
...
def medvedL(size, x, y, fish):
    ...
    d.line(screen, (0, 0, 0), (x + N * (1 - 3 / 8), y + N / 2), (x + N * 1 / 4, y), int(5*N/500))  # fishing rod

    d.ellipse(screen, (255, 255, 255), (x + N * (1 - 5/16 - 7/32), y + N * 0.4, 7 * N / 32, 3 * N / 32), 0)  # arm
    d.ellipse(screen, (0, 0, 0), (x + N * (1 - 5/16 - 7/32), y + N * 0.4, 7 * N / 32, 3 * N / 32), 1)

    d.ellipse(screen, (169, 169, 169), (x, y + N * (1 - 4 / 16), N / 2, 4 * N / 16), 0)  # proryb
    d.ellipse(screen, (0, 0, 0), (x, y + N * (1 - 4 / 16), N / 2, 4 * N / 16), 1)

    d.ellipse(screen, (0, 0, 102), (x + N * ((1 / 2 - 7 / 16) / 2), y + N * (1 - 3 / 16), 7 * N / 16, 3 * N / 16),0)  # water
    d.ellipse(screen, (0, 0, 0), (x + N * ((1 / 2 - 7 / 16) / 2), y + N * (1 - 3 / 16), 7 * N / 16, 3 * N / 16),1)

    d.line(screen, (0, 0, 0), (x + N * 1 / 4, y), (x + N * 1 / 4, y + N * (1 - 1 / 8)), 1)  # spinning

    d.line(screen, (0, 0, 0), (x + N * (1 - 5 / 16), y + 9 / 64 * N), (x + N *(1 - 15 / 32), y + 9 / 64 * N), 2)  # mouth

    d.circle(screen, (0, 0, 0), (x + N *(1 - 16 / 32), y + 5 / 64 * N), 7 * N / 600, 0)  # nose

    d.circle(screen, (0, 0, 0), (x + N * (1 - 10 / 32), y + 4 / 64 * N), 9 * N / 600, 0)  # eye

    d.circle(screen, (255, 255, 255), (x + N*(1 - 5 / 32), y + 2 / 64 * N), 18 * N / 600, 0)  # ear
    d.circle(screen, (0, 0, 0), (x + N*(1 - 5 / 32), y + 2 / 64 * N), 18 * N / 600, 1)
    if fish == 'R':
        fishR(N / 2, x, y + N)
    else:
        fishL(N / 2, x , y + N)
def fishR(size,x,y):
    N=size
    d.polygon(screen, (255,66,66), [[x,y+N/4],[x+N/8,y+N/2],[x+N/4,y+3*N/8]],0)
    d.aalines(screen, (0, 0, 0), True, [[x, y + N / 4], [x + N / 8, y + N / 2], [x + N / 4, y + 3 * N / 8]], 1)
    d.ellipse(screen, (153,153,153), (x+N/4, y+N/4, 3*N/4, N/4), 0)
    d.ellipse(screen, (0, 0, 0), (x + N / 4, y+N/4, 3 * N / 4, N / 4), 1)
    d.circle(screen, (0,0,255), (x+3*N/4,y+3*N/8), N/16, 0)
    d.circle(screen, (0, 0, 0), (x + 3 * N / 4, y + 3 * N / 8), N / 32, 0)
    d.polygon(screen, (255, 66, 66), [[x+3*N/8, y + N / 8], [x + 7*N / 8, y + N / 8], [x + 6*N / 8, y +  N / 4], [x+N/2, y+N/4]], 0)
    d.polygon(screen, (0, 0, 0),[[x + 3 * N / 8, y + N / 8], [x + 7 * N / 8, y + N / 8], [x + 6 * N / 8, y + N / 4],[x + N / 2, y + N / 4]], 1)
def fishL(size,x,y):
    N=size
    d.polygon(screen, (255,66,66), [[x+N,y+N/4],[x+N*(1-1/8),y+N/2],[x+N*(1-1/4),y+3*N/8]],0)
    d.aalines(screen, (0, 0, 0), True, [[x+N, y + N / 4], [x + N*(1-1 / 8), y + N / 2], [x + N*(1-1 / 4), y + 3 * N / 8]], 1)
    d.ellipse(screen, (153,153,153), (x, y+N/4, 3*N/4, N/4), 0)
    d.ellipse(screen, (0, 0, 0), (x, y+N/4, 3 * N / 4, N / 4), 1)
    d.circle(screen, (0,0,255), (x+N*(1-3/4),y+3*N/8), N/16, 0)
    d.circle(screen, (0, 0, 0), (x + N*(1-3/ 4), y + 3 * N / 8), N / 32, 0)
    d.polygon(screen, (255, 66, 66), [[x+N*(1-3/8), y + N / 8], [x + N*(1-7 / 8), y + N / 8], [x + N*(1-6 / 8), y +  N / 4], [x+N*(1-1/2), y+N/4]], 0)
    d.polygon(screen, (0, 0, 0),[[x + N*(1-3/8), y + N / 8], [x + N*(1-7 / 8), y + N / 8], [x + N*(1-6 / 8), y + N / 4],[x + N*(1-1/2), y + N / 4]], 1)
...
landscape()
medvedR(500, 10, 160,'R')
medvedL(100, 1400, 400,'R')
medvedR(100, 1250, 400,'L')
medvedL(333, 750, 400,'L')



screen.blit(surface1, (0,0))#'блит' поверхности на экран
pygame.display.update()  # обновление экрана для отображения картинок
